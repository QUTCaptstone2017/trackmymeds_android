...
public class GetNotificationsTask extends HTTPTask
{
	//Properties.
	private static final String GET_NOTIFICATIONS_URL = "https://trackmymeds.frb.io/get_notifications_mobile";
	...
	//Constructor.
	GetNotificationsTask(String mobileToken)
	{
		super(GET_NOTIFICATIONS_URL, mobileToken);
	}
	...
	protected void handleResponse()
	{
		...
		try
		{
			...
			if (valid)
			{
				System.out.println("Get notifications request successful.");
			...
			{
				//Give user feedback.
				System.out.println("Get notifications request failed.");
